                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                ...
                                <select id="weeksid" class="form-control" ng-required="true" ng-model="selectedWeekItem"
                                        ng-options="week.id as week.number for week in weekList"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control form-control-plaintext font-weight-bold"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="font-weight-bold">@{{calcDailyTotal()|currency}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">Proj. Weekly Rev.</h6><br>
